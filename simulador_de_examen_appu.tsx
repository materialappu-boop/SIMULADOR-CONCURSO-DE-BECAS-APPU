...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans flex flex-col antialiased">
      ...
      {showStudentRegisterModal && selectedExam && (
            ...
            {currentView === 'student-home' && (
              <div className="animate-fade-in w-full text-center">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 bg-[#f8fafc] -mt-4 relative z-20">
                  ...
                  <div 
                    id="rankings-section"
                    className="max-w-5xl mx-auto my-12 p-6 sm:p-8 bg-[#e0f2fe]/90 rounded-3xl border-2 border-blue-400 shadow-lg space-y-6 text-left animate-fade-in"
                  >
