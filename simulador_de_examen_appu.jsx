...
import { getFirestore, doc, collection, onSnapshot, addDoc, updateDoc, deleteDoc, writeBatch } from 'firebase/firestore';
...
export default function App() {
    ...
    useEffect(() => {
        if (isOfflineMode) {
            ...
            if (storedResults) {
                try {
                    finalResults = JSON.parse(storedResults);
                }
                catch (e) { }
            }
            else {
